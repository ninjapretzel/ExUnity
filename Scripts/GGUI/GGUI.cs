...
public static partial class GGUI {
	...
	public static RectTransform Render(GGUIControl c, RectTransform parent) {
		...
		// ATCHUNG ////////////////////////////////////////////////////////////////////////////////////////////////
		//////////////////////////////////////////////////////////////////////////////////////////////////////////
		// Below: Stupid hacky bullshit to make scrollRects work the way SHOULD IN THE FIRST PLACE ヽ( ･∀･)ﾉ_θ彡☆Σ(ノ `Д´)ノ
		...
		// None of this should be necessary, but it is for whatever reason. 
		////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// ATCHUNG ////////////////////////////////////////////////////////////////////////////////////////////////
		//////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void TestFunc() {
		...
		Action<int, long> procGUI = (n, seed) => {
			...
			for (int i = 0; i < n; i++) {
				...
				if (roll == 2) {
					Text(brush, "Label " + i);
					Slider(brushRight, "", Random.value, 0, 1, (f) => { Debug.Log("Cuck " + val + " : " + f); });
				}
				if (roll == 3) {
					var brushFull = brush;
					brushFull.width *= 2;
