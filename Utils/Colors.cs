...
namespace ExClient.Utils {
	...
	public static class Colors {
		...
		private static float ParseFloat(this string s) { return float.Parse(s); }
		private static int ParseInt(this string s) { return int.Parse(s); }
		private static byte ParseByte(this string s) { return byte.Parse(s, NumberStyles.HexNumber); }
		private static Color ParseColor(this string s) { return Colors.FromString(s); }
		private static Color ParseColor(this string s, char delim) { return Colors.FromString(s, delim); }
		private static List<string> ParseStringList(this string s) { return s.ParseStringList(','); }
		private static List<string> ParseStringList(this string s, char delim) { return s.Split(delim).ToList(); }
		...
		public static Color Lerp(this Color[] colors, float position) {
			if (colors.Length == 0) { return Color.white; } else if (colors.Length == 1) { return colors[0]; }
